...
ksa_compo = {
		...
		investment_coin:()=>{
			...
			+'                        <th style="text-align:center;">매수평균가</th>'
			...
			+'                            <tr id="hcoin">'
			+'                                <th>'
			+'                                    <img src="/web/resources/img/logo4.jpg" alt="원스코인" width=20px height=20px >'
			+'                                    <a class="tit" style="text-decoration: none;"><strong>원스코인</strong><i>ONCE</i></a>'
			+'                                </th>'
			+'                                <td><strong>0.00015797 <i>BTC</i></strong></td>'
			+'                                <td><em>19,469,998 <i>KRW</i></em></td>'
			+'                                <td><em>3,076 <i>KRW</i></em></td>'
			+'                                <td><em>949 <i>KRW</i></em></td>'
			+'                                <td><span><em class="down">-69.12 <i>%</i></em></span><span><em class="down">-2,126 <i>KRW</i></em></span></td>'
			+'                            </tr>'
			+'                        </tbody>'
			+'                    </table>'
			+'                </div>'
