...
ksa_compo = {
		...
		investment_coin:()=>{
			...
			+'            <div class="acctB">'
			+'                <div class="box01">'
			+'                    <span><em>총매수금액</em><strong>3,076 <i>KRW</i></strong></span><span><em>총평가금액</em><strong>949'
			+'                            <i>KRW</i>'
			+'                    </strong></span>'
			+'                </div>'
			+'                <div class="box01">'
			+'                    <span><em>총평가손익</em><strong class="down">-2,126 <i>KRW</i></strong></span><span><em>총평가수익률</em><strong'
			+'                        class="down">-69.12 <i>%</i></strong></span>'
			+'                </div>'
			+'                <div class="box01">'
			+'                    <span><em>보유 KRW</em><strong>0 <i>KRW</i></strong></span><span><em>총'
			+'                            보유자산</em><strong>949 <i>KRW</i></strong></span>'
			+'                </div>'
			+'            </div>'
			+'            <table class="ty03">'
			+'                <colgroup>'
			...
			+'                                <td class="btn"><a href="#" class="arrowBtn" title="주문">주문</a>'
			+'                                <ul class="optionBox">'
		...
		investment_trx:()=>{
			...
			+'                                    <td><strong>286,536 <i>KRW</i></strong></td>'
			+'                                    <td><strong>1,000.00 <i>KRW</i></strong></td>'
			+'                                    <td><strong>287,536 <i>KRW</i></strong></td>'
			+'                                </tr>'
			+'                                <tr>'
			...
			+'                                    <td><strong>143.83 <i>KRW</i></strong></td>'
			+'                                    <td><strong>287,536 <i>KRW</i></strong></td>'
			+'                                </tr>'
			+'                                <tr>'
			+'                                    <td class="lAlign">2017.12.30 17:39</td>'
			...
			+'                                    <td><strong>143.79 <i>KRW</i></strong></td>'
			+'                                    <td><strong>287,743 <i>KRW</i></strong></td>'
			+'                                </tr>'
			+'                            </tbody>'
			+'                        </table>'
			+'                    </div>'
		...
		d_w_krw:()=>{
			return '<span class="btnB"><em>KRW 입금(충전)을 위해 실명확인 입출금 계좌'
