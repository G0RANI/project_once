...
ksa_compo = {
		...
		investment_coin:()=>{
			...
			+'                    <span><em>총매수금액</em><strong>3,076 <i>KRW</i></strong></span>'
			+'                    <span><em>총평가금액</em><strong>949 <i>KRW</i></strong></span>'
			+'                </div>'
			+'                <div class="box01" style="padding: 0 30px 0 30px; width: 330px;">'
			+'                    <span><em>총평가손익</em><strong class="down">-2,126 <i>KRW</i></strong></span>'
			+'                    <span><em>총평가수익률</em><strong class="down">-69.12 <i>%</i></strong></span>'
			+'                </div>'
			+'                <div id="assets" class="box01" style="padding: 0 30px 0 30px; width: 330px;">'
			+'                    <span><em>보유 KRW</em><strong>0 <i>KRW</i></strong></span>'
			+'                    <span><em>총 보유자산</em><strong>949 <i>KRW</i></strong></span>'
			+'                </div>'
			+'            </div>'
			+'            <table class="ty03">'
			+'                <colgroup>'
			...
			+'                                <td class=""><em>19,469,998 <i>KRW</i></em><em><a href="" class="">수정</a></em></td>'
			+'                                <td class=""><em>3,076 <i>KRW</i></em></td>'
			+'                                <td class="selected"><em>949 <i>KRW</i></em></td>'
			+'                                <td class=""><span><em class="down">-69.12 <i>%</i></em></span><span><em class="down">-2,126 <i>KRW</i></em></span></td>'
			+'                                <td class="btn"><a href="#" class="arrowBtn" title="주문" style="margin-top:15px;">주문</a>'
			+'                                <ul class="optionBox">'
			+'                                        <li><button>BTC/KRW</button></li>'
			+'                                        <li><button>BTC/USDT</button></li>'
			+'                                </ul>'
			+'                                </td>'
			+'                            </tr>'
			+'                        </tbody>'
		...
		investment_hcoin:()=>{
		    ...
		    +'                <div id="assets" class="box01" style="padding: 0 30px 0 30px; width: 330px;">'
		    +'                    <span><em>보유 KRW</em><strong>0 <i>KRW</i></strong></span>'
		    +'                    <span><em>총보유자산</em><strong>949 <i>KRW</i></strong></span>'
		    +'                </div>'
		    +'            </div>'
		    +'            <table class="ty03">'
		    +'                <colgroup>'
		    ...
		    +'                                <th>'
		    +'                                    <img src="https://static.upbit.com/logos/BTC.png" alt="비트코인" width=20px height=20px >'
		    +'                                    <a class="tit" style="text-decoration: none;"><strong>비트코인</strong><i>BTC</i></a>'
		    +'                                </th>'
		    +'                                <td><strong>0.00015797 <i>BTC</i></strong></td>'
		    +'                                <td class=""><em>19,469,998 <i>KRW</i></em><em><a href="" class="">수정</a></em></td>'
		    +'                                <td class=""><em>3,076 <i>KRW</i></em></td>'
		...
		d_w_charge:()=>{
			...
			+'						  </span>'
			+'                        <div class="serchCoin">'
			+'                          <span class="serchInput">'
			+'                            <input placeholder="코인명/심볼검색" value="">'
			+'                            <a href="#" class="serchBt"></a><a href="#" class="cancelBt"></a></span><span'
			...
			+'                            <tr id="won" class="on">'
			+'                              <td>'
			+'                                <img src="https://static.upbit.com/logos/KRW.png" alt="원화" width=20px height=20px >'
